...
static void ONEWIRE_INPUT(TM_OneWire_t *OneWireStruct)
{
	GPIO_InitTypeDef GPIO_InitStruct;
	GPIO_InitStruct.GPIO_Pin = OneWireStruct->GPIO_Pin;
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_IN_FLOATING;
	GPIO_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(OneWireStruct->GPIOx, &GPIO_InitStruct);

}
static void ONEWIRE_OUTPUT(TM_OneWire_t *OneWireStruct)
{
	GPIO_InitTypeDef GPIO_InitStruct;
	GPIO_InitStruct.GPIO_Pin = OneWireStruct->GPIO_Pin;
...
static uint8_t ONEWIRE_READ_INPUT_PIN(TM_OneWire_t *OneWireStruct)
{
	return GPIO_ReadInputDataBit(OneWireStruct->GPIOx,OneWireStruct->GPIO_Pin);
}
static void ONEWIRE_GPIO_CLK()
{
...
uint8_t TM_OneWire_Reset(TM_OneWire_t* OneWireStruct) {
	...
	/* Check bit value */
	i = ONEWIRE_READ_INPUT_PIN(OneWireStruct);
...
uint8_t TM_OneWire_ReadBit(TM_OneWire_t* OneWireStruct) {
	...
	/* Read line value */
	if (ONEWIRE_READ_INPUT_PIN(OneWireStruct)) {
		/* Bit is HIGH */
		bit = 1;
	}
