...
void 	 ili9486_DrawBitmap_MonoChrome(uint16_t Xpos, uint16_t Ypos, uint8_t* pbmp);
void     ili9486_DrawBitmap_Grayscale4(uint16_t Xpos, uint16_t Ypos, uint8_t* pbmp);
...
LCD_DrvTypeDef   ili9486_drv =
{
  ...
  ili9486_DrawBitmap,
  ili9486_FillRect,
  ili9486_DrawBitmap_MonoChrome,
  ili9486_DrawBitmap_Grayscale4
};
...
void ili9486_DrawBitmap(uint16_t Xpos, uint16_t Ypos, uint8_t *pbmp)
{
  ...
  LCD_IO_WriteCmd8MultipleData16_RGB565(ILI9486_RAMWR, (uint16_t *)pbmp, size);
  LCD_IO_WriteCmd8(ILI9486_MADCTL);
...
void ili9486_DrawBitmap_MonoChrome(uint16_t Xpos, uint16_t Ypos, uint8_t* pbmp)
{
	  ...
	  LCD_IO_WriteData16_to_2x8(ILI9486_SIZE_Y - 1 - yEnd);
	  LCD_IO_WriteData16_to_2x8(ILI9486_SIZE_Y - 1 - yStart);
	  LCD_IO_WriteCmd8MultipleData16_Monochrome(ILI9486_RAMWR, (uint16_t *)pbmp, size);
	  LCD_IO_WriteCmd8(ILI9486_MADCTL);
	  LCD_IO_WriteData8(ILI9486_MAD_DATA_RIGHT_THEN_DOWN);
	  ILI9486_LCDMUTEX_POP();
}
void ili9486_DrawBitmap_Grayscale4(uint16_t Xpos, uint16_t Ypos, uint8_t* pbmp)
{
	  ...
	  LCD_IO_WriteData16_to_2x8(ILI9486_SIZE_Y - 1 - yEnd);
	  LCD_IO_WriteData16_to_2x8(ILI9486_SIZE_Y - 1 - yStart);
	  LCD_IO_WriteCmd8MultipleData16_Grayscale4(ILI9486_RAMWR, (uint16_t *)pbmp, size);
	  LCD_IO_WriteCmd8(ILI9486_MADCTL);
	  LCD_IO_WriteData8(ILI9486_MAD_DATA_RIGHT_THEN_DOWN);
	  ILI9486_LCDMUTEX_POP();
}
